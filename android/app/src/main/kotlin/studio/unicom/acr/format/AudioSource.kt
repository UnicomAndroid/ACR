...
enum class AudioSource {
    ...
    val sources: Array<Int>
        get() = when (this) {
            ...
            DEFAULT -> arrayOf(MediaRecorder.AudioSource.DEFAULT)
            CAMCORDER -> arrayOf(MediaRecorder.AudioSource.CAMCORDER)
        }
    ...
    val nameResId: Int
        get() = when (this) {
            ...
            DEFAULT -> R.string.audio_source_default
            CAMCORDER -> R.string.audio_source_camcorder
        }
