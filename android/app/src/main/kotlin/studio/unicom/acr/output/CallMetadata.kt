...
import studio.unicom.acr.format.FormatParamInfo
import studio.unicom.acr.format.NoParamInfo
import studio.unicom.acr.format.RangedParamInfo
import studio.unicom.acr.format.RangedParamType
...
data class CallMetadataJson(
    ...
    constructor(context: Context, metadata: CallMetadata, output: OutputJson) : this(
        ...
        simPhoneNumber = metadata.simPhoneNumber,
